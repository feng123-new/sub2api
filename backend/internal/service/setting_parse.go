...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		SiteName:                               s.getStringOrDefault(settings, SettingKeySiteName, "畅联服务"),
		SiteLogo:                               settings[SettingKeySiteLogo],
		SiteSubtitle:                           s.getStringOrDefault(settings, SettingKeySiteSubtitle, "连接优质 AI 能力，提供稳定便捷的 API 服务"),
