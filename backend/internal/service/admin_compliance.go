...
const (
	...
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意畅联服务部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the 畅联服务 Deployment and Operation Compliance Commitment"
