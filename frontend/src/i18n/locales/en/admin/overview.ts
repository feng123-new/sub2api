export default {
    ...
    groups: {
      ...
      openaiLive: {
        ...
        hint: 'When enabled, API keys in this OpenAI group can create and control Live voice sessions. Disabled by default. The 畅联服务 server must run on Apple Silicon macOS with the official ChatGPT app installed; client platforms are unrestricted.',
        unsupportedTitle: 'Current server does not support Live',
        unsupportedMessage: 'This 畅联服务 server cannot generate the required Live attestation. Live will not work even if enabled. Continue anyway?',
