export default {
    ...
    subscriptions: {
      ...
      resetTime: '重置时间',
      resetTimeTitle: '设置下次重置时间',
      resetTimeSaved: '重置时间已保存',
      failedToSaveResetTime: '保存重置时间失败',
      pleaseSelectResetWindow: '请至少选择一个额度窗口',
      resetTimeMustBeFuture: '重置时间必须晚于当前时间',
      resetTimeBeforeExpiry: '重置时间必须早于订阅到期时间',
      dailyResetTimeMustBeMidnight: '每日额度必须在服务时区（{timezone}）的 00:00 重置',
      ...
      guide: {
        ...
        actions: {
          ...
          resetTime: '重置时间',
          resetTimeDesc: '手动设置日/周/月额度窗口的下次重置时间',
          revoke: '撤销',
