export default {
    ...
    subscriptions: {
      ...
      form: {
        ...
        resetWindows: 'Quota windows',
        nextResetTime: 'Next reset time (local timezone)'
      },
      ...
      resetTimeTitle: 'Set Next Reset Time',
      resetTimeSaved: 'Reset time saved',
      failedToSaveResetTime: 'Failed to save reset time',
      pleaseSelectResetWindow: 'Select at least one quota window',
      resetTimeMustBeFuture: 'Reset time must be in the future',
      resetTimeBeforeExpiry: 'Reset time must be before subscription expiry',
      dailyResetTimeMustBeMidnight: 'Daily quota must reset at 00:00 in the server timezone ({timezone})',
      ...
      guide: {
        ...
        actions: {
          ...
          resetTime: 'Reset Time',
          resetTimeDesc: 'Set the next reset time for daily, weekly, or monthly quota windows',
          revoke: 'Revoke',
