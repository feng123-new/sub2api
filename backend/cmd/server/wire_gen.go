...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIQuotaService, codexStateManager := service.ProvideOpenAIQuotaService(accountRepository, proxyRepository, httpUpstream, gatewayCache, openAITokenProvider, privacyClientFactory, openAIGatewayService)
	codexStateAdminService := service.NewCodexStateAdminService(accountRepository, proxyRepository, codexStateManager)
	...
	codexStateHandler := admin.NewCodexStateHandler(codexStateAdminService)
