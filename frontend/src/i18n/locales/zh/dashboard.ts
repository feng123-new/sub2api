export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description:
          '配置 Grok CLI、Claude Code、Codex 或 OpenCode，让请求通过当前畅联服务 Grok 分组发送。文本模型走 Responses；图片/视频使用 Imagine 模型 ID 与媒体端点。',
        claudeDescription: '配置 Claude Code，让 Messages API 请求通过当前畅联服务 Grok 分组发送。',
        codexDescription: '配置 Codex，让 Responses API 请求通过当前畅联服务 Grok 分组发送。',
        configTomlHint:
