...
const FALLBACK_ZH_PHRASE = '我已阅读、理解并同意畅联服务部署与运营合规承诺'
const FALLBACK_EN_PHRASE = 'I have read, understood, and agree to the 畅联服务 Deployment and Operation Compliance Commitment'
