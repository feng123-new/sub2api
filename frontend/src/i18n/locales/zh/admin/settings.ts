export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于畅联服务用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于畅联服务用户登录',
      ...
      site: {
        ...
        siteSubtitlePlaceholder: '连接优质 AI 能力，提供稳定便捷的 API 服务',
        apiBaseUrl: 'API 端点地址',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: '添加当前易支付服务商额外支持的支付方式。支付方式会记录到畅联服务订单中，上游 type 会作为易支付 type 参数提交。',
